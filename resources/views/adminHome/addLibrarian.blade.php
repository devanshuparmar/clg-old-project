...
<html lang="en">
    <head>
        ...
        <title>Admin | Add New Librarian</title>
    </head>
    <body oninit="noBack()">
        <?php 
        ...
        <center>
            <table style="background:white;margin-top:5rem">
                <form action="/add/librarian-final" method="post">
                @csrf
                    <tr>
                        <td>
                            Name :
                ...
                <a href="/home-admin"><button>Back</button></a>
        </center>
