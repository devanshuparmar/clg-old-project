...
<!-- <center> -->
    <div class="container">
        ...
        <form action="/librarian/search-publishers" method="POST">
        @csrf
        ...
        <!-- <center style="z-index: 1;"> -->
            ...
            <input type="button" onclick="addNewPublishers()" class="button" value="Add New Publisher" name="btn" id="You are going to add a new publisher"><br><br><br><br><br>
        </form>
        <!-- </center> -->
        @yield('view')
    </div>
